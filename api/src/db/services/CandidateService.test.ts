...
describe("CandidateService", () => {
  ...
  it("lists candidates (persons)", () => {
    entityRepo.upsert({
      sourceId: "test", entityType: "person", name: "Alice",
      canonicalName: "alice", licenseClass: "public",
    });
    entityRepo.upsert({
      sourceId: "test", entityType: "person", name: "Bob",
      canonicalName: "bob", licenseClass: "public",
    });
    entityRepo.upsert({
  ...
  it("gets a single candidate by ID", () => {
    const id = entityRepo.upsert({
      sourceId: "test", entityType: "person", name: "Charlie",
      canonicalName: "charlie", bio: "The bio", position: "writer",
      licenseClass: "public",
    });
