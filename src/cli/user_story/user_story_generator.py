...
from snakesss.cli.user_story.user_story_basic import UserStory, UserStoryExample, get_user_story_examples
from snakesss.lib.clients.openai import openai_chat
from snakesss.lib.file_service import FileRepository

system_prompt = FileRepository.get_file_contents("snakesss/cli/user_story/user_story_prompt.md")
